...
class CV_Control:
    def __init__(self):
        self.lower_red1 = numpy.array([170, 100, 0], dtype = "uint8")
        self.upper_red1 = numpy.array([180, 255, 255], dtype = "uint8")
        self.lower_red2 = numpy.array([0, 100, 0], dtype = "uint8")
        self.upper_red2 = numpy.array([10, 255, 255], dtype = "uint8")    
...
if __name__ == '__main__':
    ...
    while True:
        ...
        cvc.detect_color(frame,cvc.lower_red1,cvc.upper_red1)
        cvc.detect_color(frame,cvc.lower_red2,cvc.upper_red2)
